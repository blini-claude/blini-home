...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold tracking-tight mb-6">Kushtet e përdorimit</h1>
      <div className="space-y-6 text-[16px] leading-[1.8] text-text-secondary">
        ...
        <div>
          <h2 className="text-xl font-bold text-text mb-2">Porositë</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-text mb-2">Produktet</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-text mb-2">Përgjegjësia</h2>
